...
import me.ramswaroop.jbot.core.slack.models.UserInfo;
...
public class SlackDao {
    ...
    public User retrieveUsernameById(String slackToken, String userId) {
    	User user = new User();
    	
    	UserInfo userResponse = restTemplate.getForObject(retrieveUserUrl, UserInfo.class, slackToken, userId);
    ...
    public RTM startRTM(String slackToken) {
        try {
        	logger.info("Slack token received: " + slackToken);
            ...
            logger.info("Trying to set object Mapper");
