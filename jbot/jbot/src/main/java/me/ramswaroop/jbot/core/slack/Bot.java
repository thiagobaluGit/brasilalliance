...
public abstract class Bot {
    ...
    public Bot() {
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(Controller.class)) {
                ...
                boolean caseon = controller.caseon();
                ...
                methodWrapper.setCaseon(caseon);
    ...
    public final void handleTextMessage(WebSocketSession session, TextMessage textMessage) throws Exception {
        ...
        try {
            ...
            User user = retrieveUsernameById(event.getUserId());
            event.setUser(user);
    ...
    public User retrieveUsernameById(String userId) {
    	return slackService.retrieveUsernameById(getSlackToken(), userId);
    }
    ...
    private MethodWrapper getMethodWithMatchingPatternAndFilterUnmatchedMethods(Event event, List<MethodWrapper> methodWrappers) {
        if (methodWrappers != null) {
            ...
            while (listIterator.hasNext()) {
                ...
                boolean iscaseon = methodWrapper.isCaseon();
    ...
    private class MethodWrapper {
		...
		public void setCaseon(boolean caseon) {
			this.caseon = caseon;
		}
